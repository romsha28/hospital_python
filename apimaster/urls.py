...
urlpatterns = [
    ...
    path('api/get-website-banner', views.getWebsiteBanners, name='get-banner'),
    path('api/get-mobile-banner', views.getMobileBanners, name='get-banner'),
    ...
    path('api/get-payment-methods', views.getPaymentModes, name='get-payment-methods'),
    #########################################################################################
